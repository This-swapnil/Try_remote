...
def load_pdf(pdf_path):
    ...
    print("\nGenerating vector database, please wait...")
...
def main():
    ...
    while True:
        ...
        # Preventing Context Overflow: Limiting History Size,
        # One problem with keeping too much history is exceeding the LLM's token limit.
        # The code avoids this by limiting history to the last 5 exchanges:
        ...
        if mode == "chat":
            ...
            response_dict = qa.invoke(full_prompt)
            response = response_dict.get("result", "No response found.")
        else:
